 ...
 * @author Admin
 */
public class DL_ThemSanpham extends javax.swing.JDialog {
List<danhmuc> lsdanhmuc;
    List<sanpham> lssanpham = new ArrayList<>();
    /**
     * Creates new form Jd_ThemDanhmuc
     */
    public DL_ThemSanpham(java.awt.Frame parent, boolean modal) {
        super(parent,modal);
        initComponents();
           fill();
    }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
            ...
            return;
             ...
             sanpham sp = new sanpham(cat_id, name, gia, status);
            int row = dao.add(sp);
             if (row>0) {
