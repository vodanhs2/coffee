 ...
 * @author Admin
 */
public class Jp_QlDanhmuc extends javax.swing.JPanel {    
 DefaultTableModel dt;
     List<danhmuc> lsdanhmuc = new ArrayList<>();
     danhmucDAO dao = new danhmucDAO();
     public static Jp_QlDanhmuc nhom;
    /**
    ...
    dt.addColumn("Màu sắc");
    lsdanhmuc = dao.read();
        if (lsdanhmuc !=null) {
            int soloai =0;
              for (danhmuc dm : lsdanhmuc) {
                  soloai++;
            Object data[] ={dm.getId(),dm.getName(),dm.getColor()};
            dt.addRow(data);
        }
        ...
        jTbdanhmuc.setModel(dt);
        for (int i = 0; i < jTbdanhmuc.getColumnCount(); i++) {
           Class<?> col = jTbdanhmuc.getColumnClass(i);
            jTbdanhmuc.setDefaultEditor(col, null);
    }
    }
    /**
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        ...
        DL_ThemDanhmuc add = new DL_ThemDanhmuc(run.QlCafe, true);
        add.setVisible(true);
    }//GEN-LAST:event_btnAddActionPerformed

    private void btnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditActionPerformed
   int select=jTbdanhmuc.getSelectedRow();
        if(select<0){
            JOptionPane.showMessageDialog(null, "Bạn chưa chọn danh mục nào !");
        }else{
            int id = (int) jTbdanhmuc.getValueAt(select, 0);
            
            DL_SuaDanhmuc edit = new DL_SuaDanhmuc(run.QlCafe, true, id);
    ...
    private void btnDelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDelActionPerformed
        // TODO add your handling code here:
        int[] selectrow = jTbdanhmuc.getSelectedRows();
        if (selectrow.length <=0) {
            JOptionPane.showMessageDialog(null, "bạn chưa chọn danh mục nào");
        }else{
            List<Integer> lsdanhmuc = new ArrayList<Integer>();
           String sp ="";
            for (int i : selectrow) {
                int id = (int) jTbdanhmuc.getValueAt(i, 0);
                lsdanhmuc.add(id);
                String tennhom = (String) jTbdanhmuc.getValueAt(i, 1);
                sp +=tennhom +"\n";
            }
            int qs = JOptionPane.showConfirmDialog(null, "Xóa danh mục: \n" + sp ,"Xóa danh mục", JOptionPane.YES_NO_OPTION);
            if (qs ==JOptionPane.YES_OPTION) {
                boolean xoa = dao.delete((ArrayList<Integer>) lsdanhmuc);
                  if (xoa == true) {
                    Filltable();
//                    try{
...
//                    }
    ...
    private void txtTimKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtTimKeyReleased
        // TODO add your handling code here:
         List<danhmuc> lsdanhmuc = dao.Search(txtTim.getText());
           dt = new DefaultTableModel();

            dt.addColumn("Mã loại");
            dt.addColumn("Tên loại");
            dt.addColumn("Màu sắc");
          if (lsdanhmuc !=null) {
            int soloai =0;
              for (danhmuc dm : lsdanhmuc) {
